...
const DEV_HOST = "192.168.11.21" // or "dps50xx.local"
...
class BackendService {
  ...
  async getDPS5020(): Promise<DPS5020Data> {
    return this.send<DPS5020Data>("getDPS5020")
  }

  async setDPS5020(field: string, value: string): Promise<{ ok: boolean }> {
    return this.send("setDPS5020", { field, value })
  }
