// The supply module's entry point, and the only thing the firmware's manifest names.
//
...
// on the device's own shell and on the relay's.
...
export const activate: ActivateFn = (shell) => {
  ...
  // the manifest exists to protect. See uiPages_ in main/app/PsuManager/PsuManager.h:
